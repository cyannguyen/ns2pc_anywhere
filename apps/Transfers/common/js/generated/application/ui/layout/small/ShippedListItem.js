...
function(declare, _LayoutWidgetBase, array, domConstruct, domClass) {
      return declare("generated.application.ui.layout.small.ShippedListItem", _LayoutWidgetBase, {
         ...
         buildRendering : function() {
            ...
            var col_item25 = row.insertCell(-1);
            col_item25.className  = 'ShippedListItem_item25_column';
            col_item25.colSpan = '3';
            col_item25.style['text-align'] = 'left';
            var div_item25 = domConstruct.create('div');
            col_item25.appendChild(div_item25);
            domClass.add(div_item25, 'hideextra');
            this._storeAttachToDomReference('item25', div_item25);
            ...
            var col_item35 = row.insertCell(-1);
            col_item35.className  = 'ShippedListItem_item35_column';
            col_item35.colSpan = '3';
            col_item35.style['text-align'] = 'left';
            var div_item35 = domConstruct.create('div');
            col_item35.appendChild(div_item35);
            domClass.add(div_item35, 'hideextra');
            this._storeAttachToDomReference('item35', div_item35);
            ...
            var row = table.insertRow(-1);
            row.className  = 'ShippedListItem_row_2A';
            ...
            var row = table.insertRow(-1);
            row.className  = 'ShippedListItem_row_2B';
            ...
            var col_item65 = row.insertCell(-1);
            col_item65.className  = 'ShippedListItem_item65_column';
            col_item65.colSpan = '3';
            col_item65.style['text-align'] = 'left';
            var div_item65 = domConstruct.create('div');
            col_item65.appendChild(div_item65);
            domClass.add(div_item65, 'hideextra');
            this._storeAttachToDomReference('item65', div_item65);
